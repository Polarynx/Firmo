    ...
    <div className="w-full flex flex-col gap-3">
      ...
      <div className="flex items-center gap-2">
        <select
          ...
          className="text-xs font-medium px-2 py-2 rounded-lg border border-gray-200 dark:border-gray-800
        ...
        {loading ? (
          <button
            onClick={onCancel}
            className="ml-auto flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-ink-900 text-gray-500 dark:text-gray-400 hover:border-red-300 hover:text-red-500 dark:hover:border-red-700 dark:hover:text-red-400 text-sm font-medium transition-all duration-150"
          >
