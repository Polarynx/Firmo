...
DEFAULT_VOICE = "en-US-AndrewMultilingualNeural"   # warm, conversational
# Picked by ear over the en-GB set. Azure's Multilingual voices are a newer
...
def extract_lines() -> list[str]:
    ...
    # Everything from the home survey through the six per-tab tours. Slicing at
    # SCRIPT and reading to the end catches them all, and the dedupe below means
